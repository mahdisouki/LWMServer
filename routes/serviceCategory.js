...
router.post('/service-categories' ,multer.single('image'), serviceCategoryCtrl.createServiceCategory);
...
router.put('/service-categories/:id' ,multer.single('image'), serviceCategoryCtrl.updateServiceCategory);
