...
router.get('/tipping', isAuth, checkRole('Driver', 'Helper'), tippingCtrl.getAllTippingRequestsForUser);
router.get('/tipping/:id', isAuth, checkRole('Driver', 'Helper'), tippingCtrl.getTippingRequestById);
